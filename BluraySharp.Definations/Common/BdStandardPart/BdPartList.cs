...
namespace BluraySharp.Common.BdStandardPart
{
		...
		where T : I, new()
	{
		...
		public BdPartList(IEnumerable<I> collection)
			: this(0, collection)
		{
		}

		public BdPartList(int lowerBound)
			: this(lowerBound, -1)
		{
		}

		public BdPartList(int lowerBound, IEnumerable<I> collection)
			: this(lowerBound, -1, collection)
		{
		}

		public BdPartList(int lowerBound, int capacity)
		{
		...
		public BdPartList(int lowerBound, int capacity, IEnumerable<I> collection)
		{
			this.lowerBound = lowerBound;
		...
		internal class UserFriendView
		{
			...
			public UserFriendView(BdPartList<T, I> list)
			{
